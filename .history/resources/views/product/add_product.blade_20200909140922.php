            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{url('add-product')}}" name="add_category" id="add_category" novalidate="novalidate">
                            {{csrf_field()}}
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea name="product_ordate" id="product_ordate"></textarea>
                                </div>
                            </div>
